        ...
        for (const auto& w : tag_words) {
            ...
            if (tag == "x") {
                ...
                if (has_cn) {
                    ...
                    // Force pure English alphabetical tokens to 'eng' (fixes single-character words like "I" or "a" being skipped)
                    bool is_all_english = true;
                    for (char c : word) {
